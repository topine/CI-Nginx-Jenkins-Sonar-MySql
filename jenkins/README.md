...
docker run -d --name jenkins -p 8080:8080 -p 50000:50000 -v /opt/jenkins:/var/jenkins_home:z -v ~/.docker:/var/.docker -v /var/run/docker.sock:/var/run/docker.sock -t travelaer/jenkins
